/**
 * ANALYTICS PRO V4 — Race Engineering Dashboard
...
const paceZones = [
  ...
  { zone: 'Z2 Aerobic',  pct: 29, color: CY,  pace: '5:00–5:30' },
  { zone: 'Z3 Tempo',    pct: 18, color: N,   pace: '4:30–5:00' },
  { zone: 'Z4 Threshold',pct: 10, color: OR,  pace: '4:00–4:30' },
  ...
  return (
    <Panel className="p-6" style={{ gridColumn: 'span 2' }}>
      <div className="flex items-center justify-between mb-5">
        <Lbl color={DM}>TRAINING DENSITY — LAST 16 WEEKS</Lbl>
...
function SplitAnalysis() {
  ...
  return (
    <Panel className="p-6">
      <div className="flex items-center justify-between mb-5">
        <Lbl color={DM}>SPLIT ANALYSIS — LAST LONG RUN</Lbl>
    ...
    <Panel className="p-6" style={{ gridColumn: 'span 2' }} accent={N}>
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-5">
          <Lbl color={N}>■ WEEKLY KM</Lbl>
          <Lbl color={OR}>— 4W AVG</Lbl>
  ...
  return (
    <Panel className="p-6" accent={OR}>
      ...
      <div className="flex items-center justify-between mt-2 pt-4" style={{ borderTop: `1px solid ${MT}` }}>
        ...
        <div><Lbl color={DM}>HEEL DROP Δ</Lbl><p style={{ fontSize: 18, fontWeight: 900, color: OR, fontFamily: 'monospace' }}>-1.2 mm</p></div>
      </div>
    </Panel>
  );
}
...
export function AnalyticsV4() {
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-4">
          <span style={{ color: N, fontSize: 10, fontWeight: 900, letterSpacing: '0.3em' }}>RACE ENGINEERING — DATA OBSERVATORY v4</span>
          <span style={{ color: MT, fontSize: 9, letterSpacing: '0.2em' }}>SESSION: 2026-04-15 · ATHLETE: #00312 · STATUS: ACTIVE</span>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <KpiTile label="VO2 MAX ESTIMATE" value="54.2" unit="ml/kg/min" sub="↑ Elite Threshold" accent={N} />
        <KpiTile label="WEEKLY VOLUME" value="68.4" unit="km" sub="↑ +8.2 vs prev week" accent={CY} />
      ...
      >
        <Lbl color={MT}>DATA LAST SYNC: 2026-04-15 · 08:32 UTC+1</Lbl>
        <div className="flex items-center gap-6">

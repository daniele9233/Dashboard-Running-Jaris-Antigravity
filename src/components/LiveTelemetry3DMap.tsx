      ...
      <div className="w-[380px] shrink-0 bg-[#070B14] border-r border-white/5 flex flex-col h-full overflow-hidden z-10">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-white/5">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-brand">Live Telemetry 3D</span>
          </div>
        ...
        <div className="px-6 py-5 border-b border-white/5">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-white/5 rounded-2xl p-4 relative overflow-hidden">
              ...
              <div className="text-2xl font-black italic text-brand tabular-nums">
                {playbackPoint ? formatPace(playbackPoint.pace) : '--:--'}
              </div>
              <div className="text-[11px] font-black text-gray-600">/KM</div>
              <Timer className="absolute top-3 right-3 w-4 h-4 text-brand/10" />
            </div>
            {/* Heart Rate */}
            <div className="bg-white/5 rounded-2xl p-4 relative overflow-hidden">
        ...
        <div className="px-6 py-4 border-b border-white/5">
          ...
          >
            <div
              className="absolute h-full bg-gradient-to-r from-brand/60 to-brand rounded-full"
              style={{ width: `${progress}%` }}
            />
            <div
              className="absolute top-1/2 -translate-y-1/2 w-3.5 h-3.5 bg-brand rounded-full shadow-[0_0_12px_rgba(192,255,0,0.5)] group-hover:scale-125 transition-transform"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <button onClick={togglePlay} className="p-3 rounded-xl bg-brand hover:bg-[#D4FF33] transition-all shadow-[0_0_20px_rgba(192,255,0,0.3)]">
            ...
            <div className="flex bg-white/5 rounded-xl overflow-hidden">
              {[0.5, 1, 2, 4].map(speed => (
                <button
                  ...
                  className={cn(
                    "px-3 py-2 text-[11px] font-black transition-all",
                    playbackSpeed === speed
                      ? "bg-brand text-black"
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar px-6 py-4 min-h-0">
          <div className="grid grid-cols-4 text-[10px] font-black uppercase tracking-[0.2em] text-gray-600 mb-3 px-2">
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isActive ? "bg-brand/10 border-brand/30 shadow-[0_0_15px_rgba(192,255,0,0.1)]"
      ...
      <div className="flex-1 relative">
          ...
          {completedRouteGeoJSON && completedRouteGeoJSON.geometry.coordinates.length > 1 && (
            <Source id="completed-route" type="geojson" data={completedRouteGeoJSON} lineMetrics>
              <Layer
                ...
                type="line"
                layout={{ 'line-join': 'round', 'line-cap': 'round' }}
                paint={{ 'line-color': BRAND, 'line-width': 14, 'line-blur': 18, 'line-opacity': 0.25 }}
              />
              <Layer
          ...
          {playbackPoint && (
            <Marker longitude={playbackPoint.coordinates[0]} latitude={playbackPoint.coordinates[1]}>
              <div className="relative">
                <div className="absolute -inset-6 animate-ping bg-brand/20 rounded-full" />
                <div className="absolute -inset-4 bg-brand/10 rounded-full animate-pulse" />
                <div className="w-6 h-6 bg-brand rounded-full border-[3px] border-white shadow-[0_0_30px_rgba(192,255,0,0.8)] flex items-center justify-center">
        ...
        {playbackPoint && isPlaying && (
          <div className="absolute top-6 right-6 pointer-events-none">
            <div className="bg-black/60 border border-white/10 rounded-2xl px-6 py-3 flex items-center gap-6 shadow-2xl">
              <div className="text-center">
                <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Pace</div>
                <div className="text-lg font-black italic text-brand tabular-nums">{formatPace(playbackPoint.pace)}</div>
              </div>
              <div className="w-px h-8 bg-white/10" />
              <div className="text-center">
                <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest">HR</div>
              ...
              <div className="w-px h-8 bg-white/10" />
              <div className="text-center">
                <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Elev</div>
                <div className="text-lg font-black italic text-amber-400 tabular-nums">{Math.round(playbackPoint.elevation)}m</div>
              </div>
              <div className="w-px h-8 bg-white/10" />
              <div className="text-center">
                <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Dist</div>

...
const CLR_CTL  = "#6366F1"; // indigo — Condizione fisica (same as PMC)
const CLR_ATL  = "#F43F5E"; // red    — Affaticamento (same as PMC)
const CLR_TSB  = "#D4FF00"; // lime   — Forma (same as PMC NEON)
...
export function FitnessFreshness({ fitnessFreshness, currentFf, prevCtl }: FitnessFreshnessProps) {
  ...
  return (
    <div
      className="bg-[#0E0E0E] border border-[#1E1E1E] rounded-xl p-6 group"
      style={{ borderLeft: `3px solid ${CLR_CTL}` }}
    >
      {/* ── Header ── */}
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <InfoTooltip title="Storico 12 mesi — stima Jack Daniels" lines={[

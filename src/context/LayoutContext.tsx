...
export const DEFAULT_LAYOUTS: Layouts = {
  lg: [
    ...
    { i: "detraining",      x: 6, y:  7, w: 6, h: 6, minW: 4, minH: 5 },
    ...
    { i: "field-test",      x: 0, y: 21, w: 4, h: 6, minW: 3, minH: 5 },
    { i: "session-logs",    x: 0, y: 27, w: 12, h: 6, minW: 6, minH: 4 },
  ],
  md: [
    { i: "status-form",     x: 0, y:  0, w: 6, h: 7 },
    { i: "vo2max",          x: 0, y:  7, w: 3, h: 3 },
    { i: "previsione-gara", x: 3, y:  7, w: 3, h: 4 },
    { i: "detraining",      x: 0, y: 14, w: 6, h: 6 },
    ...
    { i: "field-test",      x: 0, y: 39, w: 3, h: 6 },
    { i: "session-logs",    x: 0, y: 45, w: 6, h: 6 },
  ],
  sm: [
    { i: "status-form",     x: 0, y:  0, w: 1, h: 7 },
    { i: "vo2max",          x: 0, y:  7, w: 1, h: 3 },
    { i: "previsione-gara", x: 0, y: 10, w: 1, h: 4 },
    { i: "detraining",      x: 0, y: 14, w: 1, h: 6 },
    { i: "fatigue-atl",     x: 0, y: 20, w: 1, h: 4 },
    ...
    { i: "field-test",      x: 0, y: 61, w: 1, h: 6 },
    { i: "session-logs",    x: 0, y: 67, w: 1, h: 6 },
  ],
};
